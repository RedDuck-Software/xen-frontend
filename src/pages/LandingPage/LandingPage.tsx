...
import "../../index.scss"; // @todo remove duplicate imports
import "./LandingPage.scss"; // @todo remove duplicate imports
...
const LandingPage: FC = () => {
  ...
  async function getTotalInfo() {
    const provider = new ethers.providers.JsonRpcProvider(
      `https://eth-goerli.g.alchemy.com/v2/RjtXgibyHZpH_pzNdKAnh28f0Ja_UUEf` // @todo bring alchemy key to .env file
    );
